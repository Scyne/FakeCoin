...
uint256 hashGenesisBlock("0xaec9203efaf5b35bdfc136477468830da578a1f5b21f4c59cf898dbb3fb17c33");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // FakeCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "FakeCoin Signed Message:\n";
...
{
    // FakeCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // FakeCoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // FakeCoin: 3.5 days
static const int64 nTargetSpacing = 150; // FakeCoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // FakeCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // FakeCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // FakeCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x3235516c7ddfc60bb582f568f014839ad742b6e8b37a80ae92d79456aa08e83a");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "<>Nomatter what Shwood says, he is forever not racist.<>";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 5000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("4f1b353118b75e2e9e353475880ed919544c7ef59259b6af718910211b06fb8cf6f41fa05fcf7997c337c1cf06969404c7696e582dbbbcf2396616aba0b0de0818") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1512973198;
        block.nBits    = 504365644;
        block.nNonce   = 257649348;

        if (fTestNet)
        {
            block.nTime    = 1512973198;
            block.nNonce   = 1037289022;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x4b93d6e51df856f85831ce4de87d0acf4cc0c7c3e01d7303e923919ef18f5d5a"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // FakeCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("FakeCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("FakeCoinMiner : ProcessBlock, block not accepted");
    }
